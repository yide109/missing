README: Missing Data Handling in PLS-SEM
...
EM_with_weighting_methodforNMAR.R
...
Run the script. Output (e.g., imputed datasets, model summaries) will be generated as specified within the code.
Further Analysis
